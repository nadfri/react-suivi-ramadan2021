      ...
      >
        <div className="overflow-hidden">
          <div className="flex gap-2 px-4 pb-4 pt-0">
            <button 
            onClick={handleClick}
            className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-green-100 text-green-800 shadow-sm border border-green-200/50 font-bold text-sm rounded-xl active:scale-95 active:shadow-inner transition-all">
              Jeûné <BiBadgeCheck className="size-5" />
            </button>

            <button 
            onClick={handleClick}
            className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-orange-100 text-orange-800 shadow-sm border border-orange-200/50 font-bold text-sm rounded-xl active:scale-95 active:shadow-inner transition-all">
              Non Jeûné
              <BiErrorAlt className="size-5" />
            </button>
          </div>
